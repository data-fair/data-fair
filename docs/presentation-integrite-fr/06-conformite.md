...
- l'**imputation individuelle** vit dans le journal d'activité de la plateforme, qui reste modifiable et est anonymisé lors de la suppression d'un compte utilisateur — le rapprochement par date entre piste et journal redonne le « qui » tant que le journal le détient.
...
- **Le registre est l'entrepôt lui-même** : la piste de révisions se reconstitue depuis le stockage seul, sans faire confiance à la base de données de la plateforme — c'est précisément ce que le verdict de cohérence vérifie en continu.
