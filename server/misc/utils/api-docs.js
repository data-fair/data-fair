...
exports.operationsClasses = {
  datasets: {
    ...
    admin: ['delete', 'getPermissions', 'setPermissions', 'changeOwner', 'writePublications', 'writePublicationSites', 'writeExports', 'setApiKeys']
  },
  applications: {
    list: ['list'],
