...
exports.init = async (catalogUrl) => {
  debug('try fetching dcat info', catalogUrl)
  const dcat = (await axios.get(catalogUrl)).data
  ...
  if (dcat['@type'] !== 'dcat:Catalog') throw new Error('missing system/site/name in geonetwork site info')
