...
<i18n lang="yaml">
  fr:
    ...
    deprecation: La fonctionnalité "fichier distant" est dépréciée et sera supprimée dans une prochaine version. Veuillez utiliser une connecteur de catalogue ou un traitement périodique pour obtenir le même résultat.
  en:
    save: Save
    ...
    deprecation: The "remote file" functionality is deprecated and will be removed in an incoming release. Please use a catalog connector or a processing to obtain the same result.
</i18n>
