...
<i18n lang="yaml">
fr:
  saved: Les métadonnées de jeux de données ont été mises à jour
en:
  saved: Dataset metadata settings have been updated
</i18n>
...
const { t } = useI18n()
const route = useRoute<'/embed/settings/[type]/[id]/datasets-metadata'>()
