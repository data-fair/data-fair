...
- Utilise fréquemment l'outil get_current_location pour comprendre le positionnement de l'utilisateur dans l'interface
...
- Frequently use the tool get_current_location to understand the positioning of the user in the UI.
