...
const ddecruce5 = await axiosAuth('ddecruce5@phpbb.com')
const ddecruce5Org = await axiosAuth('ddecruce5@phpbb.com', 'passwd', 'KWqAGZ4mG')
const bhazeldean7 = await axiosAuth('bhazeldean7@cnbc.com')
const bhazeldean7Org = await axiosAuth('bhazeldean7@cnbc.com', 'passwd', 'KWqAGZ4mG')
const icarlens9Org = await axiosAuth('icarlens9@independent.co.uk', 'passwd', 'KWqAGZ4mG')
