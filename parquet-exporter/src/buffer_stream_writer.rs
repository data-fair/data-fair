...
impl BufferStreamWriter {
    pub fn new(cx: &mut FunctionContext, data_callback: Root<JsFunction>, end_callback: Root<JsFunction>) -> Self {
...
unsafe impl Send for BufferStreamWriter {}