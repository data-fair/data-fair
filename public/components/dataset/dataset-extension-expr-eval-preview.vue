...
fr:
  ...
  <ul>
    ...
    <li><code>DEFINED(param1)</code><br>Retourne vrai si le paramètre est défini.</li>
    <li><code>TRUTHY(param1)</code><br>Retourne vrai si le paramètre est défini et ne vaut pas false, 0 ou chaîne vide.</li>
  </ul>"
en:
