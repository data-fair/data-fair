                ...
                >
                  ...
                  <v-form ref="prodConfigForm">
                    <v-jsonschema-form
                      ...
                      :schema="prodSchema"
                      :model="configClone"
                      :options="{disableAll: true, autoFoldObjects: can('writeConfig'), context: {owner: application.owner}, requiredMessage: 'Information obligatoire', noDataMessage: 'Aucune valeur correspondante', 'searchMessage': 'Recherchez...'}"
          ...
          <v-card>
            <v-card-text class="grey lighten-3">
              <v-row>
                ...
                >
                  ...
                  >
                    ...
                    <v-jsonschema-form
                      ...
                      :schema="draftSchema"
                      :model="editConfig"
                      :options="{disableAll: !can('writeConfig'), autoFoldObjects: can('writeConfig'), context: {owner: application.owner}, requiredMessage: 'Information obligatoire', noDataMessage: 'Aucune valeur correspondante', 'searchMessage': 'Recherchez...'}"
                      @error="error => eventBus.$emit('notification', {error})"
                    />
                    <v-row class="mt-3">
                      <v-spacer />
                ...
                >
                  <v-iframe
                    v-if="showDraftPreview && expansion[1]"
