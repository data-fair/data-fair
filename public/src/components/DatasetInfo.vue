      ...
      <md-card>
        <md-list>
          ...
          <md-list-item>
            ...
            <user-name :user="usersInfo[dataset.updatedBy]"></user-name> <span>{{dataset.updatedAt | moment("DD/MM/YYYY, HH:mm")}}</span>
          </md-list-item>
          <md-list-item>
            <md-icon>add_circle_outline</md-icon>
            <user-name :user="usersInfo[dataset.createdBy]"></user-name> <span>{{dataset.createdAt | moment("DD/MM/YYYY, HH:mm")}}</span>
          </md-list-item>
        </md-list>
      </md-card>
    </md-layout>
