...
<div>
  ...
  <md-list v-if="settings">
    <md-list-item v-for="(license, rowIndex) in settings.licenses" style="padding:8px 0">
  ...
  <md-dialog md-open-from="#new-license" md-close-to="#new-license" ref="new-license-dialog">
    ...
    <md-dialog-content>
      <md-input-container>
        <label>Titre</label>
        <md-input v-model="newLicense.title"></md-input>
      </md-input-container>

      <md-input-container>
        <label>URL</label>
        <md-input v-model="newLicense.href"></md-input>
      </md-input-container>
    </md-dialog-content>
