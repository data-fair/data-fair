        ...
        <md-table v-if="userOrganizations">
          <md-table-header>
            <md-table-row>
              ...
              <md-table-head v-for="organization in Object.values(userOrganizations)" :key="organization.id">{{ organization.name }}</md-table-head>
            </md-table-row>
          </md-table-header>
          ...
          <md-table-body>
            <md-table-row>
              ...
              <md-table-cell v-for="organization in Object.keys(userOrganizations)" :key="organization.id">{{ stats.organizations[organization].datasets }}</md-table-cell>
            </md-table-row>
            <md-table-row>
              <md-table-cell>Espace consommé</md-table-cell>
              <md-table-cell>{{ stats.user.storage }}</md-table-cell>
              <md-table-cell v-for="organization in Object.keys(userOrganizations)" :key="organization.id">{{ stats.organizations[organization].storage }}</md-table-cell>
            </md-table-row>
          </md-table-body>
        </md-table>
