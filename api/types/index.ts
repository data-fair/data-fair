...
export type { Dataset, DatasetExt, DatasetInternal, RestDataset, DatasetLine, DatasetLineAction, DatasetLineRevision, VirtualDataset, FileDataset, SchemaProperty, QueryableDescendant } from './dataset/index.ts'
