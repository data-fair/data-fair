...
function peg$parse(input, options) {
  ...
  var peg$e9 = peg$literalExpectation("and", false);
  ...
  var peg$f2 = function(key, operator, value) {
    const prop = options.dataset.schema.find(p => p.key === key.name)
    if (!prop) throw httpError(400, `Impossible d'appliquer un filtre sur le champ ${key.name}, il n'existe pas dans le jeu de données.`)
  ...
  var peg$f5 = function(before, after) {
      if (!after.length) return before
      return {
        bool: {
  ...
  var peg$f9 = function() { return { type: "Literal", value: null }; };
  var peg$f10 = function() { return { type: "Literal", value: true  }; };
  var peg$f11 = function() { return { type: "Literal", value: false }; };
