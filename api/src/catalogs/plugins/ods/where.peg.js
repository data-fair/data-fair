...
function peg$parse(input, options) {
  ...
  var peg$e10 = peg$literalExpectation("to", false);
  ...
  var peg$e45 = peg$literalExpectation("e", true);
  ...
  var peg$f10 = function(key, operator, value) {
    const prop = options.dataset.schema.find(p => p.key === key.name)
    if (!prop) throw httpError(400, `Impossible d'appliquer un filtre sur le champ ${key.name}, il n'existe pas dans le jeu de données.`)
  ...
  var peg$f12 = function(before, after) {
  ...
  var peg$f13 = function(before, after) {
      if (!after.length) return before
      return {
        bool: {
  ...
  var peg$f17 = function() { return { type: "Literal", value: null }; };
  var peg$f18 = function() { return { type: "Literal", value: true  }; };
  var peg$f19 = function() { return { type: "Literal", value: false }; };
