...
function peg$parse(input, options) {
  ...
  var peg$e8 = peg$classExpectation([" ", "+", "-", ["0", ":"], "T", "Z"], false, false);
  var peg$e9 = peg$literalExpectation("geom", true);
  var peg$e10 = peg$literalExpectation("year", true);
  var peg$e11 = peg$literalExpectation("month", true);
  var peg$e12 = peg$literalExpectation("day", true);
  var peg$e13 = peg$literalExpectation("hour", true);
  var peg$e14 = peg$literalExpectation("minute", true);
  var peg$e15 = peg$literalExpectation("second", true);
  var peg$e16 = peg$literalExpectation("now()", false);
  var peg$e17 = peg$literalExpectation("now(", true);
  var peg$e18 = peg$literalExpectation(")", false);
  var peg$e19 = peg$literalExpectation("years", true);
  var peg$e20 = peg$literalExpectation("months", true);
  var peg$e21 = peg$literalExpectation("days", true);
  var peg$e22 = peg$literalExpectation("hours", true);
  var peg$e23 = peg$literalExpectation("minutes", true);
  var peg$e24 = peg$literalExpectation("seconds", true);
  ...
  var peg$e48 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true);
  ...
  var peg$f5 = function(value) { return {format: 'YYYY', value: value, level: 'year' } };
  var peg$f6 = function(value) { return {format: 'YYYY', value: value, level: 'year' } };
  var peg$f7 = function(value) { return value };
  var peg$f8 = function(name) { return {value: name.name} };
  var peg$f9 = function(year, month, day) { return {format: 'YYYY/MM/DD', value: `${year}/${month}/${day}`, level: 'day'} };
  var peg$f10 = function(year, month, day) { return {format: 'YYYY-MM-DD', value: `${year}-${month}-${day}`, level: 'day'} };
  var peg$f11 = function(year, month) { return {format: 'YYYY/MM', value: `${year}/${month}`, level: 'month'} };
  var peg$f12 = function(year, month) { return {format: 'YYYY-MM', value: `${year}-${month}`, level: 'month'} };
  ...
  var peg$f19 = function() { return text().padStart(2, '0') };
  var peg$f20 = function() { return text().padStart(2, '0') };
  ...
  function peg$parseRefine() {
    var s0, s1, s2, s3, s4, s5, s6, s7;

    s0 = peg$currPos;
    s1 = peg$parseRefineExpression();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
  ...
  function peg$parseRefineExpression() {
