...
// heavy deps (config/turf/proj4/child-process). Both functions are PURE — they only need the `flatten`
// param. geo.ts re-exports them so existing importers (shp/tiles/wkt) keep working unchanged.
