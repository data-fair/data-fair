...
* [Infos-parcelles](./user-guide/infos-parcelles) vous permet de projeter vos données sur le plan cadastral français. [Exemple sur une partie de la base MAJIC des parcelles des personnes morales](https://opendata.koumoul.com/reuses/carte-des-parcelles-des-personnes-morales-majic)
