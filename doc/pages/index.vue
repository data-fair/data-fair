    ...
    >
      <client-only>
        <iframe
          ...
          src="https://videos.koumoul.com/videos/embed/df39c1be-bd76-42dd-b930-c3afe9210c4f?title=0&warningTitle=0&peertubeLink=0&autoplay=1&loop=1"
          frameborder="0"
          allowfullscreen
        />
      </client-only>
    ...
    >
      ...
      >
        <v-img
          :aspect-ratio="2"
          alt="Accès par API"
          src="./home/undraw_uploading_go67.svg"
          contain
        />
      </v-col>
    </v-row>
    ...
    >
      ...
      >
        <v-img
          :aspect-ratio="2"
          alt="Accès par API"
          src="./home/undraw_mobile_testing_reah.svg"
          contain
        />
      </v-col>
    </v-row>
        ...
        >
          ...
          <v-card-text>
            <p class="text-caption">
              {{ sponsor.description[$i18n.locale] }}
            </p>
            <p class="mb-0 text-body-2">
              {{ sponsor.thanks[$i18n.locale] }}
            </p>
          </v-card-text>
        </v-card>
        <v-col />
