<template lang="html">
  <v-container class="index-page">
    <h2 class="text-h4 my-6">
      ...
      <v-btn
        :to="localePath({name: 'full-technical-architecture'})"
        icon
      >
    ...
    >
      <v-col>
        <nuxt-link
          :to="localePath({name: `technical-architecture-id`, params: {id: section.id}})"
          class="text-h5"
        >
          {{ i +1 }} - {{ section.title }}
        </nuxt-link>
        ...
        >
          <nuxt-link
            :to="localePath({name: `technical-architecture-id`, params: {id: subsection.id}})"
            class="text-h6"
          >
